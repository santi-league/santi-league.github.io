...
**赛季语义调整**：S0 从"首届"改成了纯测试赛季（`description: '测试用'`，不再写虚构的"2026年1月"开始时间，改成注明测试用的是哪段真实牌谱：2026年5月22日-7月22日）。真正的首届最高位战是新建的 **S1 赛季**（`src/s_league/config.py`），时间窗口 2026年7月23日0点 - 10月23日0点。
